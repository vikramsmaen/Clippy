...
const ColumnContainer = (props) => {
  ...
  // const filteredlips = clips.filter((clips) => clips.id === colId);

  return (
    <div>
      <div className=" flex flex-col  items-center justify-center  border-2  rounded-lg overflow-hidden">
        ...
        <div className="w-full p-2 border-t-2"> Column Footer</div>
      </div>
    </div>
  );
};
